...
- 在后期可无缝切换到 `AutoOpenBroswer-io/browser` 真实浏览器执行引擎
...
- real runner adapter：用于接入 `AutoOpenBroswer-io/browser`
...
### 阶段 E：真实引擎接入
1. 抽象 runner trait
2. 接入 `AutoOpenBroswer-io/browser`
