...
The same rule document also records the updated tradeoffs after planned disk expansion and the requirement that performance optimization must not collapse usable concurrency.
